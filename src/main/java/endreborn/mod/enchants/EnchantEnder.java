...
public class EnchantEnder extends Enchantment {
    ...
    public void onEntityDamaged(EntityLivingBase user, Entity target, int level) {
        if ((target instanceof EntityEnderman) || (target instanceof EntityAngryEnder) || (target instanceof EntityWatcher) || (target instanceof EntityChronologist) || (target instanceof EntityEndermite)) {
