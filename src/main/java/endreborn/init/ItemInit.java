...
public class ItemInit 
{
    ...
    public static final ArmorMaterial ARMOUR_DRAGON = EnumHelper.addArmorMaterial("armour_dragon", Reference.MODID + ":dragon", 44, new int[]{5, 8, 9, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 5.0F);
    public static final ArmorMaterial ARMOUR_HELMET_D = EnumHelper.addArmorMaterial("armour_helmet_d", Reference.MODID + ":dragon_helmet", 44, new int[]{5, 8, 9, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 5.0F);
